...
import { ChevronDownIcon, CheckIcon, ArrowRightIcon, ArrowRightEndOnRectangleIcon } from "@heroicons/react/24/outline";
      ...
      <div>
        <div className="flex bg-white pb-5 h-[100px] 2xl:h-[125px] ">
          <div className="pt-5 flex">
            ...
            <div className="mt-5 ml-10 justify-start bg-c3 w-[0px] h-2 rounded-2xl"></div>
            <ArrowRightEndOnRectangleIcon className="mt-1 -ml-2 flex h-10 w-10 stroke-c3 bg-c5 rounded-2xl stroke border-[2px] border-c3 text-c3"/>
          </div>
          <div className="pt-5 pl-10 justify-end grid grid-cols-4 gap-20">
          <Link to="/proInventory">
            ...
            <Link to="/profileUser/Addresses">
              <Button className="w-[200px] justify-end hover:bg-deep-orange-900 bg-c3 rounded-3xl text-white text-md font-[Montserrat]">
                Staff
              </Button>
            </Link>
          </div>
